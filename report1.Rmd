...
A próximo table apresenta o resultado dos cálculos dos volumes para cada aluno tanto para a régua quanto para o paquímetro:
...
rownames(dfVolume) <- c("Aluno1", "Aluno2", "Aluno3", "Aluno4")
...
rownames(dfDensity) <- c("Aluno1", "Aluno2", "Aluno3", "Aluno4")
